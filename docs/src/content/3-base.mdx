...
index: 3
title: Base
description: Base props in the Shakti library.
path: /base
---
...
<Remark>the shorthand properties in parentheses can also be used.</Remark>
...
### Text
Style the text within an element.
...
### Text Transformation
Transform the text within an element.

<PropTable propList={shaktiProps.textTransform} />
