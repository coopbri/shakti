...
The default Shakti breakpoints can be overwritten by creating a higher-order export using object composition with the <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax" target="_blank" rel="noopener noreferrer">spread operator</a>. As an example, let's say you wanted to
