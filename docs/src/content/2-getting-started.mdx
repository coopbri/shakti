...
Shakti comes with several utilities, components, and props to help you quickly create production-ready React applications. It was built with freedom and composition in mind, and allows easy access to the underlying technology. Shakti components and props compose a lightweight abstraction layer on top of vanilla HTML, vanilla CSS, and <a href="https://styled-components.com/" target="_blank" rel="noopener noreferrer">styled components</a>.  Not only can pieces of the library be imported as needed, but they can also be composed upon with ease (see <DocLink to="/recipes">Recipes</DocLink>).
